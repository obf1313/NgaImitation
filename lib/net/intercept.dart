...
class AuthInterceptor extends Interceptor{
  ...
  onRequest(RequestOptions options) {
    String accessToken = SpUtil.getString(GlobalConst.access_Token);
    if (accessToken.isNotEmpty){
      options.headers["Authorization"] = "Bearer ${SpUtil.getString(GlobalConst.access_Token)}";
    }
...
class TokenInterceptor extends Interceptor{
  ...
  onError(DioError error) async {
    ...
    if (error.response != null && error.response.statusCode == ExceptionHandle.unauthorized) {
      ...
      SpUtil.putString(GlobalConst.access_Token, accessToken);
      dio.unlock();
  ...
  Future<String> getToken() async {
    ...
    params["refresh_token"] = SpUtil.getString(GlobalConst.refresh_Token);
    try{
